...
export const dialogueData = {
  pc: `This is my PC. I work mostly in Java, JavaScript, NodeJS, ExpressJS and full Stack content these days.
    Anyway regardless of the language, I just like programming.
    Here is my <a href="https://github.com/Ma-n-a-v" target="_blank">Github</a>!`,
  "cs-degree": `This is the space for my CS degree. I will hung it on the wall. I will be graduating from The University of Winnipeg, 
  Computer Science at the University of Winnipeg provides a dynamic and inclusive learning environment, offering courses in programming, algorithms, data structures, and specialized areas like artificial intelligence and cybersecurity.`,
  "sofa-table": `Ah, that's my sofa where I kick back, unwind, and indulge in some Netflix bliss. 
  It's the ultimate cozy corner, perfect for unwinding and binge-watching my favorite shows. `,
